...
plugins=(git pip virtualenv virtualenvwrapper archlinux fasd colorize supervisor tmux sudo systemd vp upl extract zsh-syntax-highlighting kubectl oc helm util fzf terraform)
